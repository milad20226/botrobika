...
HF_TOKEN = "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"  # همین توکن قدیمی کار می‌کنه
...
if __name__ == "__main__":
    print("✅ ربات miai1 با چت (Groq) + تصویر (Hugging Face) آنلاین شد!")
    app.run()